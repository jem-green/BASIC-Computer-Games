...
200 R=X:S=1:GOTO 240
210 IF R<>H THEN 240
215 IF S<>V THEN 230
220 R=1:5=1:GOTO 250
...
334 IF Z=1 THEN 370
338 Q=1:GOTO 350
400 IF W(R,S+1)<>0 THEN 370
405 IF S<>V THEN 420
410 IF Z=1 THEN 450
415 Q=1:GOTO 430
420 IF W(R,S+1)<>0 THEN 450
430 X=INT(RND(1)*3+1)
440 ON X GOTO 790,840,910
450 X-INT(RND(1)*2+1)
470 IF S<>V THEN 490
480 IF Z=1 THEN 520
485 Q=1:GOTO 500
